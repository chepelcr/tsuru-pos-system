...
const jmarkets: ThemeDef = {
  ...
  radius: "0.5rem",
  // ── Tsuru palette (natural-pigment) ─────────────────────────────────────
  //   primary  Borgoña Tsuru   #6B2A22 → 6 52% 28%
  //   accent   Carmesí Achiote #D9381E → 8 76% 48%   (CTA / active)
  //   success  Dosel Talamanca #2E5033 → 129 27% 25% (secondary / success)
  //   bg       Arena de Mastate#F4EFE6 → 39 39% 93%
  //   text     Piedra Sĩã'     #3D4045 → 218 6% 25%
  //   gold     Oro de Maíz     #E8B83A → 43 79% 57%  (accent-rose family)
  light: {
    background: "39 39% 93%",
    foreground: "218 6% 25%",
    card: "0 0% 100%",
    "card-foreground": "218 6% 25%",
    primary: "6 52% 28%",
    "primary-foreground": "39 39% 96%",
    secondary: "129 27% 25%",
    "secondary-foreground": "39 39% 96%",
    muted: "39 30% 90%",
    "muted-foreground": "218 6% 40%",
    accent: "8 76% 48%",
    "accent-foreground": "39 39% 96%",
    ...STATUS_LIGHT,
    success: "129 27% 25%",
    border: "39 25% 85%",
    input: "39 25% 85%",
    ring: "8 76% 48%",
    sidebar: "39 30% 91%",
    "sidebar-foreground": "218 6% 25%",
    "sidebar-accent": "39 30% 86%",
    "sidebar-accent-foreground": "218 6% 25%",
    "sidebar-border": "39 25% 84%",
    "accent-rose": "43 79% 57%",
    "accent-rose-soft": "43 79% 57% / 0.15",
    "accent-rose-dim": "43 79% 57% / 0.08",
    "accent-rose-border": "43 79% 57% / 0.2",
  },
  dark: {
    background: "218 8% 10%",
    foreground: "39 39% 93%",
    card: "218 8% 14%",
    "card-foreground": "39 39% 93%",
    primary: "6 52% 42%",
    "primary-foreground": "39 39% 96%",
    secondary: "129 27% 38%",
    "secondary-foreground": "39 39% 96%",
    muted: "218 6% 20%",
    "muted-foreground": "39 15% 65%",
    accent: "8 76% 52%",
    "accent-foreground": "39 39% 96%",
    ...STATUS_DARK,
    success: "129 27% 42%",
    ...
    ring: "8 76% 52%",
    sidebar: "218 8% 12%",
    "sidebar-foreground": "39 39% 93%",
    "sidebar-accent": "218 6% 18%",
    "sidebar-accent-foreground": "39 39% 93%",
    "sidebar-border": "218 6% 20%",
    "accent-rose": "43 79% 57%",
    "accent-rose-soft": "43 79% 57% / 0.18",
    "accent-rose-dim": "43 79% 57% / 0.1",
    "accent-rose-border": "43 79% 57% / 0.3",
  },
};
