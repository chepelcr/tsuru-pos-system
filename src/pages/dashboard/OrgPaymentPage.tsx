    ...
    return (
      <div className="px-6 pt-6 pb-12 max-w-[900px] mx-auto">
        ...
        <div className="card p-5 space-y-4">
          ...
          <div>
            <div className="skeleton-block animate-pulse h-4 w-24 mb-2 rounded" />
            <div className="skeleton-block animate-pulse h-10 w-full rounded" />
            <div className="skeleton-block animate-pulse h-3 w-48 mt-1.5 rounded" />
          </div>

          {/* Two toggle rows */}
          {[0, 1].map((i) => (
            <div key={i} className="flex items-start gap-3 rounded-lg border border-border p-4">
              <div className="bg-muted/40 animate-pulse h-4 w-4 rounded mt-0.5 flex-shrink-0" />
              <div className="min-w-0 flex-1">
                <div className="skeleton-block animate-pulse h-4 w-40 rounded" />
                <div className="skeleton-block animate-pulse h-3 w-64 mt-2 rounded" />
              </div>
            </div>
          ))}
